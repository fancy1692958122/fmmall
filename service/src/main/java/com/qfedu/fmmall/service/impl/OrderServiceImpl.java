...
//            System.out.println("-----库存校验完成");
    ...
    public ResultVO getOrderById(String orderId) {
        ...
        ResultVO resultVO = new ResultVO(ResStatus.OK, "success", order.getStatus());
        return  resultVO;
    }
    ...
    public void closeOrder(String orderId) {
        synchronized (this){
        //a.修改当前订单 status=6 (关闭订单) close_type=1(超时关闭)
        //b.还原库存，先根据当前订单编号查询order_item 商品快照（skuid buy_count）
